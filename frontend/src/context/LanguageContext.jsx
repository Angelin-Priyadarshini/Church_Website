...
const translations = {
  en: {
    ...
    // Believer Portal & Login
    believerPortal: 'Believer Portal',
    login: 'Login',
    believerRegistration: 'Believer Registration',
    emailVerification: 'Email Verification',
    loginSubtitle: 'Log in to place prayer requests or manage features.',
    registerSubtitle: 'Create your account to submit and track prayers.',
    verifySubtitle: 'We sent a 6-digit verification code to ',
    emailAddress: 'Email Address',
    securityPassword: 'Security Password',
    authorizeLogin: 'Authorize Login',
    verifyingAuthority: 'Verifying authority keys...',
    creatingAccount: 'Creating account...',
    completeRegistration: 'Complete Registration',
    digitsCodeLabel: '6-Digit Verification Code',
    verifyAndActivate: 'Verify & Activate',
    verifyingCode: 'Verifying code...',
    resendCode: 'Resend Verification Code',
    backToSignIn: 'Back to Sign In',
    areYouBeliever: 'Are you a believer in the congregation?',
    registerHere: 'Register here',
    alreadyRegistered: 'Already registered?',
    signInHere: 'Sign in here',
    welcomeBelieverPortal: 'Welcome to your Believer Portal',
    hallelujah: 'Hallelujah',
    portalText: 'Manage your prayer requests, track answers, and stay connected in fellowship.',
    signOut: 'Sign Out',
    placePrayerRequest: 'Place a Prayer Request',
    prayerTeamAgreement: 'Our intercession team and pastor will stand in agreement with you.',
    prayerCategory: 'Prayer Category',
    contactPhoneOptional: 'Contact Phone (Optional)',
    requestDetails: 'Request Details',
    anonymousCheck: 'Submit anonymously to the intercessors team',
    submittingRequest: 'Submitting request...',
    yourActivePrayers: 'Your Active Prayers',
    trackAnswersDesc: 'Track your active intercessions and update answered status.',
    noPrayersSubmitted: 'No prayer requests submitted yet.',
    startInterceding: 'Submit a request above to start interceding.',
    anonymous: 'Anonymous',
    public: 'Public',
    pending: 'Pending',
    answered: 'Answered',
  ...
  ta: {
    ...
    // Believer Portal & Login
    believerPortal: 'விசுவாசிகள் தளம்',
    login: 'உள்நுழை',
    believerRegistration: 'விசுவாசிகள் பதிவு',
    emailVerification: 'மின்னஞ்சல் சரிபார்ப்பு',
    loginSubtitle: 'ஜெப விண்ணப்பங்களைச் சமர்ப்பிக்க அல்லது கணக்கை நிர்வகிக்க உள்நுழையவும்.',
    registerSubtitle: 'ஜெபங்களைச் சமர்ப்பிக்க மற்றும் கண்காணிக்க உங்கள் கணக்கை உருவாக்கவும்.',
    verifySubtitle: 'நாங்கள் 6 இலக்க சரிபார்ப்புக் குறியீட்டை அனுப்பியுள்ள முகவரி: ',
    emailAddress: 'மின்னஞ்சல் முகவரி',
    securityPassword: 'பாதுகாப்பு கடவுச்சொல்',
    authorizeLogin: 'உள்நுழைவை அனுமதி',
    verifyingAuthority: 'உள்நுழைவு சரிபார்க்கப்படுகிறது...',
    creatingAccount: 'கணக்கு உருவாக்கப்படுகிறது...',
    completeRegistration: 'பதிவை நிறைவு செய்',
    digitsCodeLabel: '6-இலக்க சரிபார்ப்புக் குறியீடு',
    verifyAndActivate: 'சரிபார்த்து செயல்படுத்து',
    verifyingCode: 'குறியீடு சரிபார்க்கப்படுகிறது...',
    resendCode: 'சரிபார்ப்புக் குறியீட்டை மீண்டும் அனுப்புக',
    backToSignIn: 'மீண்டும் உள்நுழைவுப் பக்கத்திற்கு',
    areYouBeliever: 'நீங்கள் சபையின் விசுவாசியா?',
    registerHere: 'இங்கே பதிவு செய்யவும்',
    alreadyRegistered: 'ஏற்கனவே பதிவு செய்துள்ளீர்களா?',
    signInHere: 'இங்கே உள்நுழையவும்',
    welcomeBelieverPortal: 'உங்கள் விசுவாசிகள் தளத்திற்கு வரவேற்கிறோம்',
    hallelujah: 'அல்லேலூயா',
    portalText: 'உங்கள் ஜெப விண்ணப்பங்களை நிர்வகிக்கவும், பதில்களைக் கண்காணிக்கவும் மற்றும் சபையோடு இணைந்திருக்கவும்.',
    signOut: 'வெளியேறு',
    placePrayerRequest: 'ஜெப விண்ணப்பம் சமர்ப்பிக்கவும்',
    prayerTeamAgreement: 'எங்கள் ஜெபக்குழுவினரும் போதகரும் உங்களுக்காக திறப்பில் நின்று ஜெபிப்பார்கள்.',
    prayerCategory: 'ஜெபத்தின் வகை',
    contactPhoneOptional: 'தொடர்பு எண் (விருப்பப்பட்டால்)',
    requestDetails: 'விண்ணப்பத்தின் விவரங்கள்',
    anonymousCheck: 'ஜெபக்குழுவிற்கு அநாமதேயமாக சமர்ப்பிக்கவும்',
    submittingRequest: 'சமர்ப்பிக்கப்படுகிறது...',
    yourActivePrayers: 'உங்களது ஜெப விண்ணப்பங்கள்',
    trackAnswersDesc: 'உங்கள் ஜெபங்களின் நிலையை அறிந்து கொண்டு, பதில் கிடைத்த ஜெபங்களை புதுப்பிக்கவும்.',
    noPrayersSubmitted: 'இதுவரை ஜெப விண்ணப்பங்கள் எதுவும் சமர்ப்பிக்கப்படவில்லை.',
    startInterceding: 'ஜெபிக்கத் தொடங்க மேலே ஒரு விண்ணப்பத்தைச் சமர்ப்பிக்கவும்.',
    anonymous: 'அநாமதேயம்',
    public: 'பொதுவானது',
    pending: 'பதிலுக்காக காத்திருக்கிறது',
    answered: 'பதில் கிடைத்தது',
    markAnswered: 'பதில் கிடைத்தது என குறிக்கவும்',
    updatingStatus: 'நிலை புதுப்பிக்கப்படுகிறது...',
